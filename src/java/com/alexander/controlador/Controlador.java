            ...
            case "GenerarCompra":
                ...
                if (cl.getId() != 0 && listaProductos.size() != 0 && montopagar > 0) {
                    if (totalPagar > 0.0) {
                        ...
                        co.setIdPago(idpago);
                        co.setEstado("Producto Cancelado - En Proceso de Envio");
                ...
                try {
                    ...
                    for (int i = 0; i < items.size(); i++) {
                        ...
                        if(!fileItem.isFormField()){
                            File file=new File("CD:\\FRANK\\DOCUMENTOS\\NetBeansProjects\\CarritoCompras\\web\\img\\"+fileItem.getName());
                            fileItem.write(file);
                            p.setImagen("http://localhost:8080/carrito/"+fileItem.getName());
                        }else{
